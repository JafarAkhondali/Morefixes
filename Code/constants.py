...
URL_HEAD = 'https://nvd.nist.gov/feeds/json/cve/2.0/nvdcve-2.0-'
URL_TAIL = '.json.gz'
INIT_YEAR = 2002
ORDERED_CVE_COLUMNS = ['cve_id', 'published_date', 'last_modified_date', 'description',
                       'cvss2_vector_string', 'cvss2_access_vector', 'cvss2_access_complexity', 'cvss2_authentication',
                       'cvss2_confidentiality_impact', 'cvss2_integrity_impact', 'cvss2_availability_impact', 'cvss2_base_score',
                       'cvss3_vector_string', 'cvss3_attack_vector', 'cvss3_attack_complexity', 'cvss3_privileges_required',
                       'cvss3_user_interaction', 'cvss3_scope', 'cvss3_confidentiality_impact', 'cvss3_integrity_impact',
                       'cvss3_availability_impact', 'cvss3_base_score', 'cvss3_base_severity',
                       'cvss4_vector_string', 'cvss4_attack_vector', 'cvss4_attack_complexity', 'cvss4_attack_requirements',
                       ...
                       'cvss4_base_score', 'cvss4_base_severity',
                       'cvss2_exploitability_score', 'cvss2_impact_score',
                       'cvss3_exploitability_score', 'cvss3_impact_score',
                       'reference_json', 'weakness_json', 'configurations_json']
DROP_CVE_COLUMNS = ['index', 'vulnerabilities', 'cve.references', 'cve.weaknesses', 'cve.metrics']
